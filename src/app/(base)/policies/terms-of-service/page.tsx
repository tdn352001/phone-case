...
const ContactInformation = () => {
  return (
    <PolicyContainer>
      ...
      <PolicyBody>
        <strong>OVERVIEW</strong> <br /> This website is operated by IDEASKIN. Throughout the site,
        the terms “we”, “us” and “our” refer to IDEASKIN. IDEASKIN offers this website, including
        all information, tools and Services available from this site to you, the user, conditioned
        upon your acceptance of all terms, conditions, policies and notices stated here. <br />{' '}
        <br /> By visiting our site and/ or purchasing something from us, you engage in our
        ...
        contributors of content. <br /> <br /> Please read these Terms of Service carefully before
        ...
        <br /> <br /> Any new features or tools which are added to the current store shall also be
        ...
        <br /> <br /> Our store is hosted on Shopify Inc. They provide us with the online e-commerce
        platform that allows us to sell our products and Services to you. <br /> <br />{' '}
        <strong>SECTION 1 - ONLINE STORE TERMS</strong> <br /> By agreeing to these Terms of
        Service, you represent that you are at least the age of majority in your state or province
        of residence, or that you are the age of majority in your state or province of residence and
        you have given us your consent to allow any of your minor dependents to use this site.{' '}
        <br /> You may not use our products for any illegal or unauthorized purpose nor may you, in
        the use of the Service, violate any laws in your jurisdiction (including but not limited to
        copyright laws). <br /> You must not transmit any worms or viruses or any code of a
        destructive nature. <br /> A breach or violation of any of the Terms will result in an
        immediate termination of your Services. <br /> <br />{' '}
        <strong>SECTION 2 - GENERAL CONDITIONS</strong> <br /> We reserve the right to refuse
        Service to anyone for any reason at any time. <br /> You understand that your content (not
        including credit card information), may be transferred unencrypted and involve (a)
        ...
        during transfer over networks. <br /> You agree not to reproduce, duplicate, copy, sell,
        ...
        permission by us. <br /> The headings used in this agreement are included for convenience
        ...
        material on this site is at your own risk. <br /> This site may contain certain historical
        ...
        time. <br /> We shall not be liable to you or to any third-party for any modification, price
        change, suspension or discontinuance of the Service. <br /> <br />{' '}
        ...
        Refund Policy: [LINK TO REFUND POLICY] <br /> We have made every effort to display as
        accurately as possible the colors and images of our products that appear at the store. We
        cannot guarantee that your computer monitor&apos;s display of any color will be accurate.{' '}
        <br /> We reserve the right, but are not obligated, to limit the sales of our products or
        ...
        where prohibited. <br /> We do not warrant that the quality of any products, Services,
        information, or other material purchased or obtained by you will meet your expectations, or
        that any errors in the Service will be corrected. <br /> <br />{' '}
        <strong>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</strong> <br /> We reserve
        the right to refuse any order you place with us. We may, in our sole discretion, limit or
        ...
        distributors. <br /> <br /> You agree to provide current, complete and accurate purchase and
        ...
        <br /> <br /> <strong>SECTION 7 - OPTIONAL TOOLS</strong> <br /> We may provide you with
        access to third-party tools over which we neither monitor nor have any control nor input.{' '}
        <br /> You acknowledge and agree that we provide access to such tools ”as is” and “as
        ...
        optional third-party tools. <br /> Any use by you of the optional tools offered through the
        ...
        provider(s). <br /> We may also, in the future, offer new Services and/or features through
        the website (including the release of new tools and resources). Such new features and/or
        Services shall also be subject to these Terms of Service. <br /> <br />{' '}
        ...
        not responsible for examining or evaluating the content or accuracy and we do not warrant
        and will not have any liability or responsibility for any third-party materials or websites,
        or for any other materials, products, or Services of third-parties. <br /> We are not liable
        ...
        obligation to, monitor, edit or remove content that we determine in our sole discretion to
        be unlawful, offensive, threatening, libelous, defamatory, pornographic, obscene or
        otherwise objectionable or violates any party’s intellectual property or these Terms of
        Service. <br /> You agree that your comments will not violate any right of any third-party,
        ...
        comments posted by you or any third-party. <br /> <br />{' '}
        <strong>SECTION 10 - PERSONAL INFORMATION</strong> <br /> Your submission of personal
        information through the store is governed by our Privacy Policy, which can be viewed here:
        [LINK TO PRIVACY POLICY] <br /> <br />{' '}
        <strong>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</strong> <br /> Occasionally there
        may be information on our site or in the Service that contains typographical errors,
        ...
        without prior notice (including after you have submitted your order). <br /> We undertake no
        ...
        updated. <br /> <br /> <strong>SECTION 12 - PROHIBITED USES</strong> <br /> In addition to
        ...
        or any related website for violating any of the prohibited uses. <br /> <br />{' '}
        ...
        time, without notice to you. <br /> You expressly agree that your use of, or inability to
        use, the Service is at your sole risk. The Service and all products and Services delivered
        to you through the Service are (except as expressly stated by us) provided &apos;as is&apos;
        ...
        durability, title, and non-infringement. <br /> In no case shall IDEASKIN, our directors,
        officers, employees, affiliates, agents, contractors, interns, suppliers, Service providers
        ...
        <br /> <strong>SECTION 14 - INDEMNIFICATION</strong> <br /> You agree to indemnify, defend
        and hold harmless IDEASKIN and our parent, subsidiaries, affiliates, partners, officers,
        directors, agents, contractors, licensors, Service providers, subcontractors, suppliers,
        interns and employees, harmless from any claim or demand, including reasonable attorneys’
        fees, made by any third-party due to or arising out of your breach of these Terms of Service
        or the documents they incorporate by reference, or your violation of any law or the rights
        of a third-party. <br /> <br /> <strong>SECTION 15 - SEVERABILITY</strong> <br /> In the
        event that any provision of these Terms of Service is determined to be unlawful, void or
        ...
        <strong>SECTION 16 - TERMINATION</strong> <br /> The obligations and liabilities of the
        parties incurred prior to the termination date shall survive the termination of this
        agreement for all purposes. <br /> These Terms of Service are effective unless and until
        ...
        <br /> If in our sole judgment you fail, or we suspect that you have failed, to comply with
        any term or provision of these Terms of Service, we also may terminate this agreement at any
        ...
        thereof). <br /> <br /> <strong>SECTION 17 - ENTIRE AGREEMENT</strong> <br /> The failure of
        us to exercise or enforce any right or provision of these Terms of Service shall not
        ...
        constitutes the entire agreement and understanding between you and us and governs your use
        ...
        prior versions of the Terms of Service). <br /> Any ambiguities in the interpretation of
        these Terms of Service shall not be construed against the drafting party. <br /> <br />{' '}
        ...
        with the laws of China. <br /> <br />{' '}
        <strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong> <br /> You can review the most
        current version of the Terms of Service at any time at this page. <br /> We reserve the
        right, at our sole discretion, to update, change or replace any part of these Terms of
        ...
        <br /> Questions about the Terms of Service should be sent to us at group@indivisualhub.com.{' '}
        <br /> Our contact information is posted below: <br /> [INSERT TRADING NAME] <br />{' '}
        group@indivisualhub.com <br /> [INSERT BUSINESS ADDRESS] <br /> [INSERT BUSINESS PHONE
        NUMBER] <br /> [INSERT BUSINESS REGISTRATION NUMBER] <br /> [INSERT VAT NUMBER]
      </PolicyBody>
    </PolicyContainer>
  )
}
