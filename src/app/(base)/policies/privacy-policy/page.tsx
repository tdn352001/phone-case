...
const PrivacyPolicyPage = () => {
  return (
    <PolicyContainer>
      ...
      <PolicyBody>
        <p>
          This Privacy Policy describes how www.indivisualhub.com (the “Site” or “we”) collects,
          uses, and discloses your Personal Information when you visit or make a purchase from the
          Site.
        </p>
        <h1>Contact</h1>
        <p>
          ...
          group@indivisualhub.com or by mail using the details provided below:
        </p>
        <p>
          Shiwaitaoyuan Creative Park, Nanshan District, Room 207, Building C ShenZhen, 100242 广东,
          中国
        </p>
        ...
        <p>
          ...
          Privacy Policy, we refer to any information about an identifiable individual (including
          the information below) as “Personal Information”. See the list below for more information
        ...
        <ul>
          ...
          <ul>
            ...
            <li>
              <strong>Personal Information collected:</strong> version of web browser, IP address,
              time zone, cookie information, what sites or products you view, search terms, and how
          ...
          <ul>
            ...
            <li>
              <strong>Personal Information collected:</strong> name, billing address, shipping
              address, payment information (including credit card numbers{' '}
              <i>[INSERT ANY OTHER PAYMENT TYPES ACCEPTED]</i>), email address, and phone number.
            </li>
          </ul>
          <li>
          ...
          <ul>
            ...
            <li>
              <strong>Personal Information collected:</strong>{' '}
              <i>
                [ADD ANY MODIFICATIONS TO THE INFORMATION LISTED ABOVE OR ADDITIONAL INFORMATION AS
                NEED.]
              </i>
            </li>
          </ul>
        ...
        <h2>Minors</h2>
        <p>
          The Site is not intended for individuals under the age of <i>[INSERT AGE]</i>. We do not
          intentionally collect Personal Information from children. If you are the parent or
          guardian and believe your child has provided us with Personal Information, please contact
          us at the address above to request deletion.
        </p>
        ...
        <ul>
          <li>
            <i>[INSERT IF APPLICABLE]</i> We use Google Analytics to help us understand how our
          ...
          <li>
            <i>
              [INSERT IF YOU USE A THIRD PARTY MARKETING APP THAT COLLECTS INFORMATION ABOUT BUYER
          ...
          <li>
            <i>[INSERT IF USING SHOPIFY AUDIENCES]</i> We use Shopify Audiences to help us show ads
            on other websites with our advertising partners to buyers who made purchases with other
            Shopify merchants and who may also be interested in what we have to offer. We also share
            information about your use of the Site, your purchases, and the email address associated
            with your purchases with Shopify Audiences, through which other Shopify merchants may
            make offers you may be interested in.
          </li>
          <li>
        ...
        <p>
          <i>
            [INCLUDE THE FOLLOWING SECTION IF YOUR STORE IS LOCATED IN OR IF YOU HAVE CUSTOMERS IN
            EUROPE]
          </i>
        </p>
        <h2>Lawful basis</h2>
        ...
        <p>
          We <i>[DO/DO NOT]</i> engage in fully automated decision-making that has a legal or
          otherwise significant effect using customer data.
        </p>
        <p>
          Our processor Shopify uses limited automated decision-making to prevent fraud that does
          not have a legal or otherwise significant effect on you.
        </p>
        <p>Services that include elements of automated decision-making include:</p>
        <ul>
          <li>
            Temporary blacklist of IP addresses associated with repeated failed transactions. This
            blacklist persists for a small number of hours.
          </li>
          <li>
            Temporary blacklist of credit cards associated with blacklisted IP addresses. This
        ...
        <p>
          <i>
            [INCLUDE THIS SECTION IF YOUR BUSINESS IS SUBJECT TO THE CALIFORNIA CONSUMER PRIVACY ACT
            AND SELLS PERSONAL INFORMATION AS DEFINED BY THE CALIFORNIA CONSUMER PRIVACY ACT]
          </i>
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <i>
              IF USING SHOPIFY AUDIENCES: information about your use of the Site, your purchases,
              and the email address associated with your purchase
            </i>
          </li>
          <li>
          ...
          <li>
            <i>
              if you provide a financial incentive to sell information, provide information about
        ...
        <p>
          <i>
            [INCLUDE FOLLOWING SECTION IF YOUR STORE IS LOCATED IN OR IF YOU HAVE CUSTOMERS IN
            EUROPE]
          </i>
        </p>
        <h2>GDPR</h2>
        <p>
          ...
          <i>
            [OR INSERT ALTERNATIVE INSTRUCTIONS FOR SENDING ACCESS, ERASURE, CORRECTION, AND
            PORTABILITY REQUESTS]
          </i>
        </p>
        <p>
          Your Personal Information will be initially processed in Ireland and then will be
          transferred outside of Europe for storage and further processing, including to Canada and
          the United States. For more information on how data transfers comply with the GDPR, see
        ...
        <p>
          ...
          exercise these rights, please contact us through the contact information above.{' '}
          <i>
            [OR INSERT ALTERNATIVE INSTRUCTIONS FOR SENDING ACCESS, ERASURE, CORRECTION, AND
            PORTABILITY REQUESTS]
          </i>
        ...
        <p>
          <i>
            [Be sure to check this list against Shopify’s current list of cookies on the merchant
            storefront:{' '}
        ...
        <p>
          ...
          to “Do Not Track” signals, we do not alter our data collection and usage practices when we
        ...
        <h1>Complaints</h1>
        <p>
          As noted above, if you would like to make a complaint, please contact us by e-mail or by
          mail using the details provided under “Contact” above.
        </p>
        <p>
          If you are not satisfied with our response to your complaint, you have the right to lodge
          your complaint with the relevant data protection authority. You can contact your local
          data protection authority, or our supervisory authority here:{' '}
          <i>
            [Add contact information or website for the data protection authority in your
